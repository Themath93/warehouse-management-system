...
def send_return_request(request):
    if request.method == 'POST':
        ...
        del_met = request.POST['return_method']
        subinventory = request.POST['subinventory']
        user_email = request.POST['email']
        return_method = request.POST['return_method']
        ...
        svc_key = 'RETURN'+subinventory.split('_')[1]+'_'+key_contain+str(key_count)
